...
async function enableCam(event) {
  ...
  if (webcamRunning === true) {
    ...
    // Mettre à jour le mode de fonctionnement à "IMAGE" lorsque la webcam est désactivée
    runningMode = "IMAGE";
  } else {
    webcamRunning = true;
    enableWebcamButton.innerText = "DISABLE SEGMENTATION";
    // Mettre à jour le mode de fonctionnement à "VIDEO" lorsque la webcam est activée
    runningMode = "VIDEO";
  }
